<template>
    <div>
      <div class="modal fade" id="modalEditConteudo" tabindex="-1" aria-labelledby="labelModalEditConteudo" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div class="modal-content">
  
            <div class="modal-header">
              <h1 class="modal-title fs-5" id="exampleModalLabel">Editar conteúdo</h1>
  ...
  onMounted(() => {
      const modalElement = document.getElementById('modalEditConteudo')
      if (modalElement) {
