    ...
    <div>
        <div class="d-flex">
                ...
                <div class="col-sm-4 d-flex flex-column align-items-center ">
                    <div class="logo-signacle" style="height: 200px; width: 200px;">
                        <img src="https://s3-alpha-sig.figma.com/img/46b1/ce85/7615b51c226c2d30c3b094c4f6606489?Expires=1732492800&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=XYz7~rokEtDjtwQ3ymwovLGJ28zjunI-5ZBjuttpVpiXNV-eoFpsYndehqGSD~zG1JM1kmfzqcTB~AzHKKyiImaTzJOv3htiYVaYQpEo7G-04mI3t0cMN29j-YPcToy13na1RnhIYks40WZPclKpJXsXGfiRJhJZn86uBsicDGylu1o4063VpsBebXFl4r~JF5tOfH0E-nJrMoFKdfkVjKyUocXo4~zw1p-pT63Ce6GYs77jkHO2B733w8wEjxU3k2fhjOOOWQBDETht64HYdyznqetK8zROwj3VSDEaedSY-Q5Q1gJZhGk0ghmSj2sB1yxT7ZA00eNCZgTFdfXhcg__"
                         class="card-img-top" alt="...">
                    </div>
                    <div class="embed-responsive embed-responsive-16by9" style="align-items: end;">
                        <iframe src="https://www.youtube.com/embed/EZxkymw426U" title="Alfabeto de LIBRAS - COMPLETO E INESQUECÍVEL" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    </div>
                </div>
        </div>
    </div>
...
.dropdown-image {
   display: none;
    ...
    /* Exibe a imagem quando passa o mouse */
.hover-div:hover .dropdown-image {
    display: block;
}
