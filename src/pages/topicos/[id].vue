<template>
  	<div>
    	<div class="container py-4">
			...
			<button v-if="userStore.apiToken" class="btn btn-outline-light mt-4 ms-4" @click="navigatoToManage">
				<i class="bi bi-gear"></i>
			</button>

      		<div class="row mt-4">
				<div class="col-md-4">
					<div class="card mb-3" v-if="topics.length > 0">
					...
					<div class="card p-4 mb-3 d-flex align-items-center justify-content-center" v-if="!topics.length">
